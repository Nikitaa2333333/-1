                ...
                <div className="bg-brand-hot text-white rounded-[3rem] p-12 md:p-20 text-center relative overflow-hidden">
                    ...
                    <div className="relative z-10 max-w-3xl mx-auto space-y-8">
                        ...
                        <div className="flex flex-col sm:flex-row gap-6 justify-center pt-8">
                            <a href="https://t.me/apelsinkabarbot" target="_blank" rel="noopener noreferrer" className="flex items-center justify-center gap-3 bg-white text-brand-hot px-8 py-5 rounded-full font-bold text-xl hover:bg-brand-cream active:scale-95 transition-all duration-200">
