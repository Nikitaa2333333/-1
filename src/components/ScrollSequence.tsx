...
export const ScrollSequence = () => {
    ...
    return (
        <div ref={containerRef} className="h-[500vh] w-full bg-[#B68D8A] relative">
            <div className="sticky top-0 h-[100dvh] w-full overflow-hidden bg-[#B68D8A]">
                ...
                <motion.div style={{ opacity: opA, y: yA }} className="absolute inset-0 flex flex-col justify-center items-center px-[10%] pointer-events-none text-center">
                    <div className="relative z-10 max-w-4xl">
                        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[150%] h-[150%] -z-10 mix-blend-screen bg-[radial-gradient(circle,#FF0080_0%,transparent_70%)] blur-[80px] opacity-100" />
                        <h1 className="font-dela text-[clamp(32px,7vw,80px)] leading-[1.1] text-white mb-8">Привет, это «Апельсинка»</h1>
                        <p className="font-sans text-lg md:text-2xl text-white font-medium max-w-2xl mx-auto">Свежая ягода в бельгийском шоколаде, полностью ручная работа.</p>
                    </div>
                </motion.div>
                ...
                <a href="#products" className="absolute bottom-10 left-1/2 -translate-x-1/2 z-50 bg-white text-brand-dark py-5 px-10 rounded-full font-sans font-bold text-lg hover:bg-brand-pink transition-all active:scale-95 shadow-2xl pointer-events-auto">
                    Выбери свой вкус
                </a>
            </div>
        </div>
